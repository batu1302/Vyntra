...
export default function ReferenzenPage() {
  const stats = [
    { label: "Projekte", value: "150+", icon: CheckCircle },
                ...
                return (
                  ...
                  >
                    ...
                    <div className="text-4xl font-bold text-[#1a1a1a] mb-2">
                      {stat.value}
                      {stat.suffix && (
                        <span className="text-lg text-[#6a6a6a]"> {stat.suffix}</span>
                      )}
                    </div>
              ...
              {projects.map((project, index) => {
                ...
                return (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    transition={{ duration: 0.6, delay: index * 0.1 }}
                    className={`${project.className} p-8 rounded-2xl bg-white border border-gray-200 hover:border-[#00CED1]/50 transition-all duration-300`}
                  >
        ...
        <section className="py-24 bg-white">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-[#f5f5f5] rounded-3xl p-8 md:p-12">
              ...
              <p className="text-lg text-[#4a4a4a] leading-relaxed text-center max-w-3xl mx-auto">
                Über 150 erfolgreiche Projekte sprechen für sich. Von kleinen Business-Websites
