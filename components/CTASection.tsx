...
export default function CTASection() {
  return (
    <GlassCard className="relative overflow-hidden bg-white border border-gray-200" hover={false}>
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="px-8 py-4 bg-white border-2 border-[#00CED1] text-[#00CED1] text-lg font-semibold rounded-full hover:bg-[#00CED1]/5 transition-all duration-300"
            >
              Kostenlose Beratung
            </motion.a>
          </div>
          ...
          {/* Trust Badge */}
          <div className="mt-10 flex items-center justify-center gap-6 text-sm text-[#6a6a6a]">
